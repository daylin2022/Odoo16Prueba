...
class DiscussChannel(models.Model):
    ...
    def message_post(self, *, message_type='notification', **kwargs):
        ...
        if self.channel_type == 'whatsapp' and message_type == 'comment':
    ...
    def _get_whatsapp_channel(self, whatsapp_number, wa_account_id, sender_name=False, create_if_not_found=False, related_message=False):
        ...
        :returns: whatsapp discussion mail.channel
        """
        ...
        if not channel and create_if_not_found:
            ...
            if related_message:
                ...
                if hasattr(related_record, 'message_post'):
                    ...
                    url = Markup('{base_url}/web#model=mail.channel&id={channel_id}').format(
    ...
    def _channel_message_notifications(self,message, message_format=False):
        ...
        if member:
            ...
            new_member = self.env['mail.channel.member'].with_context(tools.clean_context(self.env.context)).sudo().create([{
            ...
            notifications.append((self, 'mail.channel/insert', {
                'channelMembers': [('insert', list(new_member._mail_channel_member_format().values()))],
                'id': self.id,
